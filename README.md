...
```
The code will throw an exception is the attacked position is outside the board, or by adding a ship outside the board or on the top of an existing ship.
